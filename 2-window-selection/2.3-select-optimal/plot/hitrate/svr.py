...
# plt.title('SVR train set hitrate preprocessing methodology and offset', fontsize=textsize)
...
# Set title and labels
# plt.title('SVR test set hitrate preprocessing methodology and offset', fontsize=textsize)
plt.xlabel('Preprocessing methodology and offset', fontsize=textsize)
plt.ylabel('Hitrate', fontsize=textsize)
...
# Set title and labels
# plt.title('SVR maximum average hitrate preprocessing methodology and offset', fontsize=textsize)
plt.xlabel('Preprocessing methodology and offset', fontsize=textsize)
plt.ylabel('Hitrate', fontsize=textsize)

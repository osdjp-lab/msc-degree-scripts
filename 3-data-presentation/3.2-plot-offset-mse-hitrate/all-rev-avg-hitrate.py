...
width = 0.25  # Width for grouped bars

# Grouped bar chart
plt.bar(x - width, hitrate_mlp['avg_hitrate'].to_numpy(), width, label="MLP-ln")
plt.bar(x, hitrate_rf['avg_hitrate'].to_numpy(), width, label="RF-r")
plt.bar(x + width, hitrate_svr['avg_hitrate'].to_numpy(), width, label="SVR-lds")

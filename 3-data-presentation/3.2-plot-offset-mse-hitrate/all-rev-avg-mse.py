...
# Grouped bar chart
plt.bar(x - width, mse_mlp['avg_mse'].to_numpy(), width, label="MLP-ln")
plt.bar(x, mse_rf['avg_mse'].to_numpy(), width, label="RF-r")
plt.bar(x + width, mse_svr['avg_mse'].to_numpy(), width, label="SVR-lds")

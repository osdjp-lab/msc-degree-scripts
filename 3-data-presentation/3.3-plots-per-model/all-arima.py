...
for offset in range(1, 13):
    ...
    # if offset not in (1,2,5,9,11,12):
    #     continue
    # if offset not in (3,4,6,7,8,10):
    #     continue

    # Select offset plot for Hitrate
    # if offset not in (1,2,3,6,7,8):
    #     continue
    # if offset not in (4,5,9,10,11,12):
    #     continue
    
    # By MSE
    # if offset not in (1,12,11,3):
    #     continue
    # if offset not in (4,5,6,7):
    #     continue
    # if offset not in (8,10,2,9):
    #     continue
    
    # By Hitrate
    # if offset not in (6,1,7,8,3,2):
    #     continue
    # if offset not in (5,9,4,10,11,12):
    #     continue

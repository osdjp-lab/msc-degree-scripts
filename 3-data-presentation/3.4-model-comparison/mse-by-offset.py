...
MLP_DIR = Path("../../data/2-training-testing/mlp/log-normalized/41-USD/")
RF_DIR = Path("../../data/2-training-testing/rf/raw/41-USD/")
SVR_DIR = Path("../../data/2-training-testing/svr/log-diff-standardized/41-USD/")
ARIMA_DIR = Path("../../data/2-training-testing/arima/log-differenced/41-USD/")

...
# File paths
mlp_mse = Path("../../data/3-training-testing/optuna/mlp/rev_mse_results.csv")
rf_mse = Path("../../data/3-training-testing/optuna/rf/rev_mse_results.csv")
svr_mse = Path("../../data/3-training-testing/optuna/svr/rev_mse_results.csv")

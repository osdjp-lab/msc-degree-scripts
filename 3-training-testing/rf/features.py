...
with open("../../data/3-training-testing/rf/optimal_dataset_dir.txt", 'r') as file:
...
max_features = [d.get('max_features') for d in cv_results['params']]
score = cv_results['mean_test_score']

output_df = pd.concat([pd.Series(max_features, name='max_features'),

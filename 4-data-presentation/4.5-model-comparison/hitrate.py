...
# File paths
mlp_hitrate = Path("../../data/3-training-testing/optuna/mlp/rev_hitrate_results.csv")
rf_hitrate = Path("../../data/3-training-testing/optuna/rf/rev_hitrate_results.csv")
svr_hitrate = Path("../../data/3-training-testing/optuna/svr/rev_hitrate_results.csv")

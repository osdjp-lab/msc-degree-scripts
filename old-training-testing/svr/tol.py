...
param_grid = {
    'tol': np.linspace(0.00001, 0.1, 1000)
}
...
output_dir = "../../data/3-training-testing/svr"
...
tol = [d.get('tol') for d in cv_results['params']]
score = cv_results['mean_test_score']

output_df = pd.concat([pd.Series(tol, name='tol'),

...
input_dir = '../../../data/2-window-selection/2-optimal/rf/mae'
...
# plt.title('RF train set MAE preprocessing methodology and offset', fontsize=textsize)
...
# Set title and labels
# plt.title('RF test set MAE preprocessing methodology and offset', fontsize=textsize)
plt.xlabel('Preprocessing methodology and offset', fontsize=textsize)
plt.ylabel('MAE', fontsize=textsize)
...
# Set title and labels
# plt.title('RF minimum average MAE preprocessing methodology and offset', fontsize=textsize)
plt.xlabel('Preprocessing methodology and offset', fontsize=textsize)
plt.ylabel('MAE', fontsize=textsize)
